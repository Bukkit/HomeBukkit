...
public class RemoveHomeCommand implements CommandExecutor {
    ...
    public RemoveHomeCommand(HomeBukkit plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (player == null) {
            ...
            sender.sendMessage(ChatColor.RED + "You don't have permission to delete someone else's home!");
            return true;
        ...
        if (home == null) {
            player.sendMessage(ChatColor.RED + "I can't delete a home that doesn't exist!");
            return true;
        }

        plugin.getDatabase().delete(home);
        
        player.sendMessage(ChatColor.RED + "Home \""+home.getName()+"\" removed!");
